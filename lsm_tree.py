...
class LSMTree:
    def __init__(self, memtable_max_size: int = 1000, segment_chunk_size_for_indexing: int = 100):
    ...
    def read_from_db(self, key: str) -> Optional[int]:
        ...
        try: 
            ...
            LOGGER.info(f'key: {key} not in in memory memtable')
    ...
    def get_floor_ceil_of_key_in_index(self, inputted_key: str, index: RedBlackTree) -> Tuple(int, int):
        """
